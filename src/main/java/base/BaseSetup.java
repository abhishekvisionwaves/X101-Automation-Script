...
public class BaseSetup {
	...
	public void Login() throws InterruptedException {
		...
		// Decrypt the password using EncryptionUtil
		String decryptedPassword = EncryptionUtil.decrypt(encryptedPassword);
		
		driver.findElement(By.xpath("//input[contains(@class, 'mdc-text-field__input') and contains(@placeholder, 'Enter email')]")).sendKeys(email);
		driver.findElement(By.xpath("//img[contains(@src, 'arrow.svg') and contains(@class, 'eyeimg') and @alt='view']")).click();
		driver.findElement(By.xpath("//input[contains(@class, 'mdc-text-field__input') and contains(@placeholder, 'Enter password')]")).sendKeys(decryptedPassword);
		driver.findElement(By.xpath("//label[contains(@id, 'kc-login')]//img[contains(@class, 'eyeimg') and contains(@src, 'arrow.svg')]")).click();
	}
